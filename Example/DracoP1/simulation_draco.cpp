...
#include "SceneGraph/srSpaceRenderer.h"
#include <vector>
#include <err.h>
#include <signal.h>
#include <stdexcept>
...
{
  gDyn_env->m_Space->DYN_MODE_RUNTIME_SIMULATION_LOOP();
}
...
int main(int argc, char **argv) 
{
  parse_options(argc, argv);
    ...
    render.InitializeRenderer(argc, argv, SceneGraphRenderer::SINGLE_WINDOWS, false);
  ...
  printf("main 1\n");
    ...
    render.InitializeNode(gDyn_env->m_Space);
  printf("main 2\n");
render.setUpdateFunc(User_Simulation_Go_One_Step);
  printf("main 3\n");

...
void Texture3DS::Load(char *name)
{
...
void Texture3DS::LoadBMP(char *name)
{
	srgBitmap bmp;
...
void Texture3DS::LoadTGA(char *name)
{
...
void Texture3DS::BuildColorTexture(unsigned char r, unsigned char g, unsigned char b)
{
